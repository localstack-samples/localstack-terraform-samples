## WebSocket API with HTTP integration
...
This template creates a WebSocket API that forwards the request body to an HTTP endpoint using integration type `HTTP`
