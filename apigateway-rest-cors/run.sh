...
response=$(curl -s -X OPTIONS "http://localhost:4566/restapis/$restapi/dev/_user_request_/test" -H "Access-Control-Request-Headers: Content-Type,Authorization,X-Amz-Date,X-Api-Key,X-Amz-Security-Token")
