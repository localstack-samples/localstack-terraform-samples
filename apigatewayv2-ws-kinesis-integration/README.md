## WebSocket API with Kinesis Stream integration (WIP)
...
This template creates a WebSocket API with a single route `/echo` that forwards the request body to a Kinesis stream.
